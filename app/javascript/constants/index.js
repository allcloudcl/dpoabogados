...
// from https://gist.github.com/rhernandog/7d055482f5cc803852a762de873bea62
export const REGIONES_PROVINCIAS_COMUNAS = [
  {
  ...
  },
  {
    ...
    provincias: [
      ...
      {
        name: "Isla de Pascua",
        comunas: [{ name: "Isla de Pascua", code: "05201" }],
      },
      {
        name: "Los Andes",
        comunas: [
    ...
    provincias: [
      {
        ...
        comunas: [
          ...
          { name: "Codegua", code: "06102" },
          { name: "Coinco", code: "06103" },
          { name: "Coltauco", code: "06104" },
          { name: "Doñihue", code: "06105" },
          { name: "Graneros", code: "06106" },
          { name: "Las Cabras", code: "06107" },
          { name: "Machalí", code: "06108" },
          { name: "Malloa", code: "06109" },
          { name: "Mostazal", code: "06110" },
          { name: "Olivar", code: "06111" },
          { name: "Peumo", code: "06112" },
          { name: "Pichidegua", code: "06113" },
          { name: "Quinta de Tilcoco", code: "06114" },
          { name: "Rengo", code: "06115" },
          { name: "Requínoa", code: "06116" },
          { name: "San Vicente", code: "06117" },
        ],
      },
      {
        name: "Cardenal Caro",
        comunas: [
          ...
          { name: "La Estrella", code: "06202" },
          { name: "Litueche", code: "06203" },
          { name: "Marichihue", code: "06204" },
          { name: "Navidad", code: "06205" },
          { name: "Paredones", code: "06206" },
        ],
      },
      {
        name: "Colchagua",
        comunas: [
          { name: "San Fernando", code: "06301" },
          { name: "Chépica", code: "06302" },
          { name: "Chimbarongo", code: "06303" },
          { name: "Lolol", code: "06304" },
          { name: "Nancagua", code: "06305" },
          { name: "Palmilla", code: "06306" },
          { name: "Peralillo", code: "06307" },
          { name: "Placilla", code: "06308" },
          { name: "Pumanque", code: "06309" },
          { name: "Santa Cruz", code: "06310" },
        ],
      },
    ],
  },
    ...
    provincias: [
      {
        ...
        comunas: [
          ...
          { name: "Curepto", code: "07103" },
          { name: "Empedrado", code: "07104" },
          { name: "Maule", code: "07105" },
          { name: "Pelarco", code: "07106" },
          { name: "Pencahue", code: "07107" },
          { name: "Río Claro", code: "07108" },
          { name: "San Clemente", code: "07109" },
          { name: "San Rafael", code: "07110" },
        ],
      },
      {
        name: "Cauquenes",
        comunas: [
          ...
          { name: "Chanco", code: "07202" },
          { name: "Pelluhue", code: "07203" },
        ],
      },
      {
        name: "Curicó",
        comunas: [
          ...
          { name: "Hualañé", code: "07302" },
          { name: "Licantén", code: "07303" },
          { name: "Molina", code: "07304" },
          { name: "Rauco", code: "07305" },
          { name: "Romeral", code: "07306" },
          { name: "Sagrada Familia", code: "07307" },
          { name: "Teno", code: "07308" },
          { name: "Vichuquén", code: "07309" },
        ],
      },
      {
        name: "Linares",
        comunas: [
          ...
          { name: "Colbún", code: "07402" },
          { name: "Longaví", code: "07403" },
          { name: "Parral", code: "07404" },
          { name: "Retiro", code: "07405" },
          { name: "San Javier", code: "07406" },
          { name: "Villa Alegre", code: "07407" },
          { name: "Yerbas Buenas", code: "07408" },
        ],
      },
    ],
  },
    ...
    provincias: [
      {
        name: "Diguillín",
        comunas: [
          { name: "Chillán", code: "16101" },
          { name: "Chillán Viejo", code: "16102" },
          { name: "Quillón", code: "16103" },
          { name: "Bulnes", code: "16104" },
          { name: "San Ignacio", code: "16105" },
          { name: "El Carmen", code: "16106" },
          { name: "Pinto", code: "16107" },
          { name: "Pemuco", code: "16108" },
          { name: "Yungay", code: "16109" },
        ],
      },
      {
        name: "Itata",
        comunas: [
          { name: "Quirihue", code: "16201" },
          { name: "Cobquecura", code: "16202" },
          { name: "Ninhue", code: "16203" },
          { name: "Treguaco", code: "16204" },
          { name: "Coelemu", code: "16205" },
          { name: "Portezuelo", code: "16206" },
          { name: "Ránqui", code: "16207" },
        ],
      },
      {
        name: "Punilla",
        comunas: [
          { name: "San Carlos", code: "16301" },
          { name: "Ñiquén", code: "16302" },
          { name: "Coihueco", code: "16303" },
          { name: "San Fabián", code: "16304" },
          { name: "San Nico", code: "16305" },
        ],
      },
    ],
  },
    ...
    provincias: [
      {
        ...
        comunas: [
          ...
          { name: "Carahue", code: "09102" },
          { name: "Cunco", code: "09103" },
          { name: "Curarrehue", code: "09104" },
          { name: "Freire", code: "09105" },
          { name: "Galvarino", code: "09106" },
          { name: "Gorbea", code: "09107" },
          { name: "Lautaro", code: "09108" },
          { name: "Loncoche", code: "09109" },
          { name: "Melipeuco", code: "09110" },
          { name: "Nueva Imperial", code: "09111" },
          { name: "Padre Las Casas", code: "09112" },
          { name: "Perquenco", code: "09113" },
          { name: "Pitrufquén", code: "09114" },
          { name: "Pucón", code: "09115" },
          { name: "Saavedra", code: "09116" },
          { name: "Teodoro Schmidt", code: "09117" },
          { name: "Toltén", code: "09118" },
          { name: "Vilcún", code: "09119" },
          { name: "Villarrica", code: "09120" },
          { name: "Cholchol", code: "09121" },
        ],
      },
      {
        name: "Malleco",
        comunas: [
          ...
          { name: "Collipulli", code: "09202" },
          { name: "Curacautín", code: "09203" },
          { name: "Ercilla", code: "09204" },
          { name: "Lonquimay", code: "09205" },
          { name: "Los Sauces", code: "09206" },
          { name: "Lumaco", code: "09207" },
          { name: "Purén", code: "09208" },
          { name: "Renaico", code: "09209" },
          { name: "Traiguén", code: "09210" },
          { name: "Victoria", code: "09211" },
        ],
      },
    ],
  },
    ...
    provincias: [
      {
        ...
        comunas: [
          ...
          { name: "Corral", code: "14102" },
          { name: "Lanco", code: "14103" },
          { name: "Los Lagos", code: "14104" },
          { name: "Máfil", code: "14105" },
          { name: "Mariquina", code: "14106" },
          { name: "Paillaco", code: "14107" },
          { name: "Panguipulli", code: "14108" },
        ],
      },
      {
        name: "Ranco",
        comunas: [
          ...
          { name: "Futrono", code: "14202" },
          { name: "Lago Ranco", code: "14203" },
          { name: "Río Bueno", code: "14204" },
        ],
      },
    ],
  },
    ...
    provincias: [
      {
        ...
        comunas: [
          ...
          { name: "Calbuco", code: "10102" },
          { name: "Cochamó", code: "10103" },
          { name: "Fresia", code: "10104" },
          { name: "Frutillar", code: "10105" },
          { name: "Los Muermos", code: "10106" },
          { name: "Llanquihue", code: "10107" },
          { name: "Maullín", code: "10108" },
          { name: "Puerto Varas", code: "10109" },
        ],
      },
      {
        name: "Chiloé",
        comunas: [
          { name: "Castro", code: "10201" },
          { name: "Ancud", code: "10202" },
          { name: "Chonchi", code: "10203" },
          { name: "Curaco de Vélez", code: "10204" },
          { name: "Dalcahue", code: "10205" },
          { name: "Puqueldón", code: "10206" },
          { name: "Queilén", code: "10207" },
          { name: "Quellón", code: "10208" },
          { name: "Quemchi", code: "10209" },
          { name: "Quinchao", code: "10210" },
        ],
      },
      {
        name: "Osorno",
        comunas: [
          { name: "Osorno", code: "10301" },
          { name: "Puerto Octay", code: "10302" },
          { name: "Purranque", code: "10303" },
          { name: "Puyehue", code: "10304" },
          { name: "Río Negro", code: "10305" },
          { name: "San Juan de la Costa", code: "10306" },
          { name: "San Pablo", code: "10307" },
        ],
      },
      {
        name: "Palena",
        comunas: [
          { name: "Chaitén", code: "10401" },
          { name: "Futaleufú", code: "10402" },
          { name: "Hualaihué", code: "10403" },
          { name: "Palena", code: "10404" },
        ],
      },
    ],
  },
    ...
    provincias: [
      {
        name: "Coyhaique",
        comunas: [
          { name: "Coihaique", code: "11101" },
          { name: "Lago Verde", code: "11102" },
        ],
      },
      {
        name: "Aisén",
        comunas: [
          { name: "Aisén", code: "11201" },
          { name: "Cisnes", code: "11202" },
          { name: "Guaitecas", code: "11203" },
        ],
      },
      {
        name: "Capitán Pratt",
        comunas: [
          { name: "Cochrane", code: "11301" },
          { name: "O'Higgins", code: "11302" },
          { name: "Tortel", code: "11303" },
        ],
      },
      {
        name: "General Carrera",
        comunas: [
          { name: "Chile Chico", code: "11401" },
          { name: "Río Ibáñez", code: "11402" },
        ],
      },
    ],
  },
    ...
    provincias: [
      {
        ...
        comunas: [
          ...
          { name: "Laguna Blanca", code: "12102" },
          { name: "Río Verde", code: "12103" },
          { name: "San Gregorio", code: "12104" },
        ],
      },
      {
        name: "Antártica Chilena",
        comunas: [
          { name: "Cabo de Hornos", code: "12201" },
          { name: "Antártica", code: "12202" },
        ],
      },
      {
        ...
        comunas: [
          ...
          { name: "Primavera", code: "12302" },
          { name: "Timaukel", code: "12303" },
        ],
      },
      {
        name: "Última Esperanza",
        comunas: [
          { name: "Natales", code: "12401" },
          { name: "Torres del Paine", code: "12402" },
        ],
      },
    ],
  },
