    ...
    return (
      <div className="tui-full-calendar-popup">
        <div className="tui-full-calendar-popup-container">
          <div
            className={
              "tui-full-calendar-popup-section tui-full-calendar-dropdown tui-full-calendar-close tui-full-calendar-section-calendar " +
              (this.props.calendars.length > 0 ? "" : "tui-full-calendar-hide")
            }
          >
            <button className="tui-full-calendar-button tui-full-calendar-dropdown-button tui-full-calendar-popup-section-item">
              <span
                className="tui-full-calendar-icon tui-full-calendar-calendar-dot"
                style={"background-color: " + selectedCal.bgColor}
              ></span>
              <span
          ...
          <div className="tui-full-calendar-popup-section">
            <div className="tui-full-calendar-popup-section-item tui-full-calendar-section-start-date">
              ...
              <input
                id="tui-full-calendar-schedule-start-date"
                className="tui-full-calendar-content"
                placeholder="{{startDatePlaceholder-tmpl}}"
              />
              <div
                id="tui-full-calendar-startpicker-container"
                style="margin-left: -1px; position: relative"
              ></div>
            </div>
            ...
            <div className="tui-full-calendar-popup-section-item tui-full-calendar-section-end-date">
              <span className="tui-full-calendar-icon tui-full-calendar-ic-date"></span>
              <input
                id="tui-full-calendar-schedule-end-date"
                className="tui-full-calendar-content"
                placeholder="{{endDatePlaceholder-tmpl}}"
              />
              <div
                id="tui-full-calendar-endpicker-container"
                style="margin-left: -1px; position: relative"
              ></div>
            </div>
          </div>
        ...
        <div
          ...
          className="tui-full-calendar-popup-arrow tui-full-calendar-arrow-bottom"
        >
